...
a = int(input('Ввведите расстояние которое спортсмен пробежал в первый день\n >>> '))
b = int(input('Сколько километров должен пробежать спортсмен на последний день?\n >>> '))

idx = 1
while idx < 100:
    a *= 1.1
    idx += 1
    print('{0}-й день: {1}'.format(idx, a))
    if a >= b:
        break
